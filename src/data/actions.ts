...
export const actions: Action[] = [
  ...
  },
  {
    ...
    primeMovers: ["erector_spinae", "multifidus", "iliopsoas", "hamstrings"],
  ...
  },
  {
    ...
    countNote:
      "The hand and forearm alone hold dozens of muscles — the named grip muscles here are the heavy lifters; finer contributors vary with exactly how you cradle the device.",
    hiddenLoad:
